          ...
          <div className="contentt">
            ...
            <p className="copyy-alt">
              <ul className="achi-list-founderr">
                <li>
                  1996 Second Position in Auli National Winter Games Open Skiing
                  Championship
                </li>
          ...
          <div className="contentt">
            ...
            <p className="copyy-alt">
              <ul className="achi-list-founderr">
                ...
                <li>
                  2012 Third Position in National Snowboarding Championship
                  Gulmarg, J&K
                </li>
          ...
          <div className="contentt">
            ...
            <p className="copyy-alt">
              <ul className="achi-list-founderr">
                ...
                <li>
                  2000 First Position in Winter Sports Junior Championship
                  Slalom Auli
                </li>
                <li>
                  2008 First Position in 5th National Winter Games
                  Gulmarg(Kashmir)
                </li>
                <li>2011 Second Position in Auli Skiing Open Championship</li>
                <li>
                  2013 First Position in National Senior Alpine Sking
                  Championship(GS)
                </li>
              </ul>
            </p> */}
