            ...
            <div className="heyy">
              ...
              <Row>
                <Col className="sec1">
                  ...
                  taken over, but we are still out here standing with this
                  work's actual value and tradition. The rawness and ethereal
                  beauty of trekking are lost. The original and traditional
                  trekking culture is endangered now. We at Pac Auli can get you
                  where you want to go and give our assurance and standard
                  trips. Since its inception, trekking has been a family thing
                  for us. Our company aims to discover uncharted routes ,
                  unmapped trails and harbor traditional trekking values. Our
                  local knowledge ensures quality work and gives a touch of
              ...
              <Row>
                <Col className="sec1">
                  The Himalayas have an intriguing history dated back thousands
                  of years ago. Each pass is unique and has some fascinating
                  stories related to Indian Philosophy and Mahabharata. Our
                  ancestors and descendants of Garhwali Shepherds have explored
                  these Himalayan and Tibetan mountain passes.
                </Col>
              </Row>
              <Row>
                <Col className="sec1">
                  ...
                  rafters, and paragliders, where you get to encounter the
                  genuine Himalayan adventure better than anyone else. Our
                  company is affiliated with the Uttrakhand Tourism and
                  adventure association of Joshimath Garhwal.
                </Col>
              </Row>
              <Row>
                <Col xs={12} md={6} lg={3}>
